...
// This class now only contains the logic specific to the G2 scheme.
public class BlstBLS12381 extends AbstractBlstBLS12381 {
    ...
    private static final String POP_CIPHERSUITE = "BLS_POP_BLS12381G2_XMD:SHA-256_SSWU_RO_POP_";
